...
export let CENTER_GRID_THICKNESS = 4;
export let CENTER_GRID_COLOR = 0;
export let SECANDERY_GRID_THICKNESS = 2;
export let SECANDERY_GRID_COLOR = 96 + 96<<8 + 96<<16;
export let THIRD_GRID_THICKNESS = 1;
export let THIRD_GRID_COLOR = 128 + 128<<8 + 128<<16;
export let GRID_LOG_LEVEL = 5;

export let DESMOS_ELEMENT_HEIGHT = 80;
export let DESMOS_ELEMENT_ERROR_HEIGHT = 40
